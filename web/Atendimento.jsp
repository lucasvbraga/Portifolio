                    ...
                    <div class="col-md-6 col-sm-12">
                        <center><h4>Escolha o tipo de Atendimento!</h4>
                            <form action="MeusAtendimentos"><select   name="filtro" id="f" ><font style="color: #314034;">
                                ...
                                <button class="w3-button w3-xlarge w3-circle w3-sand" type="submit"><span class="glyphicon glyphicon-search"></span></button></form>
                        </center> 
                        <table class="w3-table-all" id="saida">
                            ...
                            <%
                                for (int i = 0; i < normal.size(); i++) {
                                    ...
                                    out.print("<tr class=\"w3-hover-teal\"> <form action=\"detalhaAtendimento\" >");
                                    out.print("<td>" + normal.get(i).getCodigo() + "</td>");
                                    out.print("<td> Normal </td>");
                                    out.print("<td><textarea cols=4 rows=3 class=\"w3-hover-teal\" readonly>" + normal.get(i).getDescricao() + "</textarea></td>");
                                    out.print("<td>" + normal.get(i).getEspecialidade() + "</td>");
                                    out.print("<td><button class=\"w3-button w3-round-xxlarge w3-teal\" name=\"botao\" type=\"submit\" value=\"" + normal.get(i).getCodigo() + "\">" + "+" + "</button></td>");
                                    out.print("</form></tr>");
                                }  
                                ...
                                for (int j = 0; j < agendado.size(); j++) {
                                    ...
                                    out.print("<td><textarea cols=4 rows=3 class=\"w3-hover-teal\" readonly>" + agendado.get(j).getDescricao() + "</textarea></td>");
                                    out.print("<td>" + agendado.get(j).getEspecialidade() + "</td>");
                                    out.print("<td><button class=\"w3-button w3-round-xxlarge w3-teal\" name=\"botao\" type=\"submit\" value=\"" + agendado.get(j).getCodigo() + "\">" + "+" + "</button></td>");
                                    out.print("</form></tr>");
                                }
                                    ...
                                    out.print("<td><textarea class=\"w3-hover-teal\" cols=4 rows=3 readonly>" + emergencial.get(k).getDescricao() + "</textarea></td>");
                                    out.print("<td>" + emergencial.get(k).getEspecialidade() + "</td>");
                                    out.print("<td><button class=\"w3-button w3-round-xxlarge w3-teal\" name=\"botao\" type=\"submit\" value=\"" + emergencial.get(k).getCodigo() + "\">" + "+" + "</button></td>");
                                    out.print("</form></tr>");
                                }
