<%-- 
    Document   : erro404
    Created on : 22/11/2017, 15:09:54
    Author     : Lucas
--%>
...
<html>
    ...
    <body style="background-color:#FFFFFF">
        ...
        <div class="jumbotron" >
            ...
            <center><h2><font style="color: whitesmoke"> OOOps!! Algum erro nos dados informados!</font> </h2>
            <br><br><a href="main.jsp"> <button class="w3-btn w3-teal">Página Inicial</button></a></center>
        </div>
    </center>
