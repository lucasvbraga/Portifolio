<%-- 
    Document   : enviarOfertaEmergencial
    Created on : 26/10/2017, 02:39:27
    Author     : Lucas
--%>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <table class="w3-table ">
                            ...
                            <tr>
                                ...
                                <td><%=tipo%></td>
                                <td><textarea readonly><%=emergencial.get(0).getDescricao()%></textarea></td>
...
//alert("Busca iniciada com sucesso");
                    ...
                    document.forms['f'].action = "ofertaEnviadaEmergencial";
