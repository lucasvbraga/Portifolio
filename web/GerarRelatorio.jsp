        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                ...
                <div class="col-md-5 col-sm-">
                    <h2>Selecione o Tipo de</h2> <h1>Relatório</h1><h2>que deseja gerar?</h2> 
                </div>
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <form action="perfil"><a href="AnalisarPrestador.jsp"><button class="w3-button  w3-dark-grey w3-xxlarge" type="submit" style="width:100%"><h3 style="color:silver">CADASTRO</h3></button></a></form>   
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <a href=""><button class="w3-button  w3-dark-grey w3-xxlarge" type="submit" style="width:100%"><h3 style="color:silver"> NORMAL </h3></button></a>
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <form action=""><button class="w3-button  w3-dark-grey w3-xxlarge" type="submit" style="width:100%"><h3 style="color:silver">EMERGENCIAL</h3></button></form>   
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <form action=""><button class="w3-button  w3-dark-grey w3-xxlarge" type="submit" style="width:100%"><h3 style="color:silver">AGENDADO</h3></button></form>   
