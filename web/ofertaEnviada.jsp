<%-- 
    Document   : ofertaEnviada
    Created on : 26/10/2017, 01:03:36
    Author     : Lucas
--%>
    ...
    <body>
        <div class="jumbotron" >
            ...
            <br><br><br><center>
                ...
                <h6>Fique atendo(a) a seus <i><a href="ServicosARealizar">SERVIÇOS PARA REALIZAR</a></i>, <br>caso o Cliente escolha sua oferta este atendimento aparecerá lá!</h6><br>
                <img src="./img/ok.png" class="w3-hover-opacity" alt="Norway" style="width:15%">
                <br><br><a href="principalPrestador.jsp"><button class="w3-btn w3-teal"  >Voltar</button></a>
            </center>
