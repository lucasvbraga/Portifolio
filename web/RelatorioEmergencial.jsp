<%-- 
    Document   : RelatorioEmergencial
    Created on : 17/11/2017, 01:07:51
    Author     : Lucas
--%>
...
<html>
    <head>
        ...
        <%
            ...
            int qtde = (Integer) session.getAttribute("Relqtdeemergencial");
            int periodo = (Integer) session.getAttribute("Relperiodoemergencial");
            List<Double> estimada = (List) session.getAttribute("relestimadaemergencial");
            List<Integer> proximosperiodos = (List) session.getAttribute("relproximosperiodosemergencial");
            List<Integer> qtdeEspecialdades = (List) session.getAttribute("relqtdeespecemergencial");
            String dStr = (String) session.getAttribute("datahoje");
            List<Especialidade> especialdades = (List) session.getAttribute("relqtdeespecialidadeemergencial");
            int total = (Integer) session.getAttribute("relqtdeemergencialtotais");
        %>
        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                ...
                <div class="col-md-5 col-sm-">
                    ...
                    <form action="GerarEmergencial"><input type="date" max="<%=dStr%>" name="data" style="width: 38%"> <button type="submit" class="w3-btn w3-blue-gray">Gerar</button> </form>
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-12">
                        ...
                        <h3> A estimativa de  crescimentode do atendimento emergencial é a seguinte:</h3><br>
                        <div id="chartdiv"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <h3> A quantidade total de  Atendimento Emergencial no período foi de    : <font style="color: burlywood"> <%= qtde%></font></h3><br>
                    </div>
                ...
                <div class="row"><br><br><br>
                    ...
                    <div class="col-md-10 col-sm-12">
                        <h3> A quantidade de especialidade/Atendimento Emergencial totais no sistema é a seguinte:</h3>

                        <div id="chartdiv2"></div>
                        <h3> A quantidade de Atendimentos emergencial totais no sistema é : <font style="color: burlywood"> <%= total%> </h3>
                    </div>
