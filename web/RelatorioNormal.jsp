...
<html>
    <head>
        ...
        <%
            ...
            int qtde = (Integer) session.getAttribute("Relqtdenormal");
            int periodo = (Integer) session.getAttribute("Relperiodonormal");
            List<Double> estimada = (List) session.getAttribute("relestimadanormal");
            List<Integer> proximosperiodos = (List) session.getAttribute("relproximosperiodosnormal");
            List<Integer> qtdeEspecialdades = (List) session.getAttribute("relqtdeespecnormal");
            List<Especialidade> especialdades = (List) session.getAttribute("relqtdeespecialidadenormal");
            String dStr = (String) session.getAttribute("datahoje");
            int total = (Integer) session.getAttribute("relqtdenormaltotais");
        %>
        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                ...
                <div class="col-md-5 col-sm-">
                    ...
                    <form action="GerarNormal"><input type="date" max="<%=dStr %>" name="data" style="width: 38%"> <button type="submit" class="w3-btn w3-blue-gray">Gerar</button> </form>
                    <% if (periodo<0){%>
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-12">
                        ...
                        <h3> A estimativa de  crescimentode do atendimento normal é a seguinte:</h3><br>
                        <div id="chartdiv"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <h3> A quantidade total de  Atendimento Normal no período foi de    : <font style="color: burlywood"> <%= qtde %></font></h3><br>
                    </div>
                ...
                <div class="row"><br><br><br>
                    ...
                    <div class="col-md-10 col-sm-12">
                        <h3> A quantidade de especialidade/Atendimento Normal totais no sistema é a seguinte:</h3>

                        <div id="chartdiv2"></div>
                        <h3> A quantidade de Atendimentos normal totais no sistema é : <font style="color: burlywood"> <%= total %> </h3>
                    </div>
