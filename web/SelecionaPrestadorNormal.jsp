    ...
    <body>
        <div class="jumbotron" >
            ...
            <center><h3> Por favor <%=nomeUsuario%> escolha seu prestador </h3>
                ...
                <br>
                <div class="row">
                    <% for (int i = 0; i < solnm.size(); i++) {
                            p = prestadores.get(solnm.get(i).getId_prestador());
                    %>
                    <div class="col-md-3 col-sm-">


                        <div class="w3-card-4" ><form action="AtualizaPrestadorEmNormal">
                                <header class="w3-container w3-light-grey">
                                    <h3  ><%= solnm.get(i).getNome_prestador()%></h3>
                                </header>
                                    <div >
                                    <% if (p.isSexo()) {%>
                                    ...
                                    <%}%>
                                    <hr>
                                    <h4>Valor do serviço = <%= solnm.get(i).getValor()%></h4><br>
                                    <p><%= cq.NivelStr(p)%> </p>
