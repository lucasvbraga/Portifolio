    ...
    <body>
        <div class="jumbotron" >
                ...
                <div class="col-md-10 col-sm-">
                    <center><div class="columns" style="width: 100%;color: #4CAF50">
                            <ul class="price">
                                ...
                                <li class="grey"><%=agendado.get(0).getValor()%></li>
                                <li>Prestador: <%=agendado.get(0).getPrestador().getNome()%></li>
                                <li>Especialidade: <%=agendado.get(0).getEspecialidade()%></li>
                                <li>Descrição: <%=agendado.get(0).getDescricao()%></li>
                                <li>Data Marcada <%=agendado.get(0).getData_marcada()%></li>
                                <li>Hora marcada: <%=agendado.get(0).getHora_marcada()%></li>                               
            ...
            <div class="row">
                <div class="col-md-1 col-sm-"></div>
                <div class="col-md-10 col-sm-">
                    <% if (agendado.get(0).getStatus() >= 4) {%>

                    <div class="columns" style="width: 100%;color: #4CAF50">
                            <ul class="price">
                                <li class="header w3-blue-gray">Ordem de Pagamento</li>

                                <li class="grey">Pagar: R$<%=agendado.get(0).getValor()%></li>
                                <li>ao Prestador: <%=agendado.get(0).getPrestador().getNome()%></li>
