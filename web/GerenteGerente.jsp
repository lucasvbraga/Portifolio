...
<html>
    <head>
        ...
        <%
            List<Gerente> gerentes = (List) session.getAttribute("gerentescarregados");
        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                <div class="col-md-4 col-sm-">
                    <p>&emsp;&emsp;Bem vindo <%=nomeUsuario%>!<a href="LogoutCliente.jsp"><button class="w3-btn w3-white w3-border w3-border-red w3-tiny w3-round">SAIR</button></a><button onclick="history.go(-1)" class="w3-btn w3-white w3-border w3-border-black w3-tiny w3-round">VOLTAR</button></a></p>
                ...
                <div class="col-md-2 col-sm-">
                    ...
                    <a href="CadastroGerente.jsp"><button  class="w3-btn w3-blue-gray">Cadastre um novo gerente</button></a>
                    ...
                    <div class="col-md-10 col-sm-12">
                        ...
                        <table class="w3-table-all" id="myTable">
                            ...
                            <%for (int i = 0; i < gerentes.size(); i++) {%>
                                    ...
                                    <tr class="w3-hover-dark-grey"> <form action="deletaGerente" >
                                        <td> <%=gerentes.get(i).getNome()%> </td>
                                        <td> <%=gerentes.get(i).getCpf()%></td>     
                                       
                                <td><button class="w3-button w3-round-xxlarge w3-red " name="botao" type="submit" value="<%=gerentes.get(i).getId()%>"><center><span class="glyphicon glyphicon-trash "></span></center></button></td> 
                                    </form></tr>
                                <%}%>
