<%-- 
    Document   : RelatorioAgendado
    Created on : 16/11/2017, 23:26:43
    Author     : Lucas
--%>
...
<html>
    <head>
        ...
        <%
            ...
            int qtde = (Integer) session.getAttribute("Relqtdeagendado");
            int periodo = (Integer) session.getAttribute("Relperiodoagendado");
            List<Double> estimada = (List) session.getAttribute("relestimadaagendado");
            List<Integer> proximosperiodos = (List) session.getAttribute("relproximosperiodosagendado");
            List<Integer> qtdeEspecialdades = (List) session.getAttribute("relqtdeespecagendado");
            List<Especialidade> especialdades = (List) session.getAttribute("relqtdeespecialidadeagendado");
            int total = (Integer) session.getAttribute("relqtdeagendadototais");
        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                <div class="col-md-4 col-sm-">
                    <p>&emsp;&emsp;Bem vindo <%=nomeUsuario%>!<a href="principalGerente.jsp"><button class="w3-btn w3-white w3-border w3-border-red w3-tiny w3-round">SAIR</button></a><a href="principalCliente.jsp"><button class="w3-btn w3-white w3-border w3-border-black w3-tiny w3-round">VOLTAR</button></a></p>

                </div>

                <div class="col-md-5 col-sm-">
                    <h5>A partir de qual data deseja gerar o relatório?</h5>
                    <form action="GerarAgendado"><input type="date" max="<%=dStr%>" name="data" style="width: 38%"> <button type="submit" class="w3-btn w3-blue-gray">Gerar</button> </form>
                    <% if (periodo<0){%>
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-12">
                        ...
                        <h3> A estimativa de  crescimentode do atendimento agendado é a seguinte:</h3><br>
                        <div id="chartdiv"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <h3> A quantidade total de  Atendimento Agendado no período foi de    : <font style="color: burlywood"> <%= qtde%></font></h3><br>
                    </div>
                ...
                <div class="row"><br><br><br>
                    ...
                    <div class="col-md-10 col-sm-12">
                        <h3> A quantidade de especialidade/Atendimento Agendado totais no sistema é a seguinte:</h3>

                        <div id="chartdiv2"></div>
                        <h3> A quantidade de Atendimentos agendado totais no sistema é : <font style="color: burlywood"> <%= total%> </h3>
                    </div>
