    ...
    <body>
        <div class="jumbotron" >
            ...
            <br><div class="row">
                ...
                <div class="col-md-2 col-sm-">
                    ...
                    <center>
                        <div class="w3-card-4" ><form action="PerfilPrestador.jsp">
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <a href="solicitacao.jsp"><button class="w3-button  w3-teal w3-xxlarge" type="submit" style="width:100%"><h3 style="color:black">ACHAR SERVIÇOS </h3></button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <form action="AgendaPrestador"><button class="w3-button  w3-light-green w3-xxlarge" type="submit" style="width:100%"><h3 style="color:black">AGENDA</h3></button></form>   
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <form action="ServicosARealizar"><button class="w3-button  w3-light-green w3-xxlarge" type="submit" style="width:100%"><h3 style="color:black">SERVIÇOS PARA REALIZAR <span class="w3-badge w3-margin-left w3-white" ><%= conta.Abertos(p) %></span></h3> </button></form>   
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <button class="w3-button  w3-light-green w3-xxlarge" onclick="Advertencia()" style="width:100%"><h3 style="color:black"><span class="glyphicon glyphicon-bullhorn" >&nbsp;<%= p.getAdvertencia() %></span>&nbsp;&nbsp;&nbsp; &ensp;&ensp; &nbsp;<span class="glyphicon glyphicon-alert" >&nbsp;<%= p.getSuspensao() %></span></button>  

                    </div>
                    <div class="col-md-4 col-sm-12">

                        <a href="ServicosAntigos"><button class="w3-button  w3-light-green w3-xxlarge" type="submit" style="width:100%"><h3 style="color:black">SEUS SERVIÇOS ANTIGOS <span class="w3-badge w3-margin-left w3-white"><%= conta.Realizados(p) %></span></h3></button></a>
            ...
            <center>
               <img src="./img/lock.png" class="w3-hover-opacity" alt="Norway" style="width:8%">
                <h3>Desculpe, mas seu cadastro está bloqueado</h3><h6>Isto ocorreu por causa de suas suspensões!</h6></center>
        <%}%>
        </div>
        ...
        <script>
            ...
            function Advertencia(){
                alert("Você possui: \n "  + <%= p.getAdvertencia() %> + "  advertências e \n" + <%= p.getSuspensao() %> + "  suspensões" );
