    ...
    <body>
        <div class="jumbotron" >
                ...
                <div class="col-md-10 col-sm-">
                    <center><div class="columns" style="width: 100%;color: #4CAF50">
                            <ul class="price">
                                ...
                                <li class="grey"><%=normal.get(0).getValor()%></li>
                                <li>Prestador: <%=normal.get(0).getPrestador().getNome()%></li>
                                <li>Especialidade: <%=normal.get(0).getEspecialidade()%></li>
                                <li>Descrição: <%=normal.get(0).getDescricao()%></li>
            ...
            <div class="row">
                <div class="col-md-1 col-sm-"></div>
                <div class="col-md-10 col-sm-">
                    <% if (normal.get(0).getStatus() == 4) {%>

                    <div class="columns" style="width: 100%;color: #4CAF50">
                        <ul class="price">
                            <li class="header w3-blue-gray">Ordem de Pagamento</li>

                            <li class="grey">Pagar: R$<%=normal.get(0).getValor()%></li>
                            <li>ao Prestador: <%=normal.get(0).getPrestador().getNome()%></li>
