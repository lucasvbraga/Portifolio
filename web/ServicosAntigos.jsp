...
<html>
    <head>
        ...
        <%  //HttpSession sessao;
            ...
            String saida = "";
            normal = (List) session.getAttribute("antigosnormal");
            agendado = (List) session.getAttribute("antigosagendado");
            emergencial = (List) session.getAttribute("antigosemergencial");
