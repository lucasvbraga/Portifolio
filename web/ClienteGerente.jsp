<%-- 
    ...
    Created on : 11/11/2017, 11:39:45
    Author     : ra21601909
--%>
...
<html>
    <head>
        ...
        <%  
            List<Cliente> clientes = (List) session.getAttribute("clientescarregados");
        ...
        <div class="jumbotron" >
            ...
            <br><div class="row">
                ...
                <div class="col-md-5 col-sm-">
                    <h2>Pesquise o</h2> <h1>Cliente</h1>
                </div>
                    ...
                    <div class="col-md-10 col-sm-12">
                        ...
                        <table class="w3-table-all" id="myTable">
                            ...
                            <%for (int i = 0; i < clientes.size(); i++) {%>
                                    ...
                                    <tr class="w3-hover-dark-grey"> <form action="deletaCliente" >
                                        <td> <%=clientes.get(i).getNome()%> </td>
                                        <td> <%=clientes.get(i).getCpf()%></td>     
                                       
                                <td><button class="w3-button w3-round-xxlarge w3-red " name="botao" type="submit" value="<%=clientes.get(i).getId()%>"><center><span class="glyphicon glyphicon-trash "></span></center></button></td> 
                                    </form></tr>
                                <%}%>
