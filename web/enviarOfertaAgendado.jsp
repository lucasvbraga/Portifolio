<%-- 
    Document   : enviarOferta
    Created on : 24/10/2017, 14:49:59
    Author     : Lucas
--%>
                    ...
                    <div class="col-md-8 col-sm-12">
                        <table class="w3-table ">
                            ...
                            <tr>
                                ...
                                <td><%=tipo%></td>
                                <td><textarea readonly><%=agendado.get(0).getDescricao()%></textarea></td>
                                <td><%=agendado.get(0).getEndereco()%></td>
                                <td><%=agendado.get(0).getData_marcada()%></td>
...
//alert("Busca iniciada com sucesso");
                    ...
                    document.forms['f'].action = "ofertaEnviadaAgendado";
