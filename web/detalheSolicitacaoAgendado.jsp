<%-- 
    Document   : detalheSolicitacaoAgendado
    Created on : 15/11/2017, 01:28:39
    Author     : Lucas
--%>
...
<html>
    <head>
        ...
        <%
            ...
            List<Agendado> agendado = (List) session.getAttribute("servico");
            String tipo = "Agendado";
            String status = "";
             if (agendado.get(0).getStatus() == 1) {
