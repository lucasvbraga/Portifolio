<%-- 
    ...
    Created on : 16/11/2017, 00:52:02
    Author     : Lucas
--%>
...
<html>
    <head>
        ...
        <%  
           ...
           Gerente g = (Gerente) session.getAttribute("gerente");
        ...
        <div class="jumbotron" >
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><h5><font color="#FFFFFF">Olá <%=g.getNome() %> </font></h5></li>
            ...
            <br><br><br><div class="row">
                ...
                <center><div class="col-md-4 col-sm-11">
                    ...
                    <h2 id="perfil"><%=g.getNome() %></h2>
                    <h3 id="perfil">CPF:   <%=g.getCpf() %></h3>
                    <h3 id="perfil">Email:  <%=g.getEmail() %></h3>
                    <h3 id="perfil">Data de Nascimento:<%=fmat.FormataData(g.getData_nascimento()) %></h3><br><br>
                    <form action="" name="altera">Senha:<input type="password" id="alterar" onclick="Alterar()" value="<%=g.getSenha()%>" name="senha"><div id="bt"></div></form><br><br>
                    <a href="principalGerente.jsp"><button  class="w3-btn w3-blue-gray">Voltar</button></a>
                </div>
 ...
 <script>
            ...
            function Alterar() {
                ...
                a.value = "";
                a.type = "text"
                bt.innerHTML = "<br><button onclick=\"Envia()\" class=\"w3-btn w3-amber \" value=\"<%=g.getId()%>\" name=\"botao\">Alterar</button><button onclick=\"Cancela()\" class=\"w3-btn w3-deep-orange \">Cancelar</button>";
            ...
            function Envia() {
                ...
                if (a.value == "" || a.value == null) {
                    ...
                    document.forms['altera'].action = "AlteraGerente";
