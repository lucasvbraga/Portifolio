<%-- 
    Document   : SelecionaPrestadorEmergencial
    Created on : 01/11/2017, 03:20:54
    Author     : Lucas
--%>

<%@page import="model.SolicitacaoEmergencial"%>
<%-- 
    Document   : SelecionaPrestadorNormal
    Created on : 01/11/2017, 03:18:35
    Author     : Lucas
--%>

<%@page import="model.SolicitacaoNormal"%>
<%-- 
    Document   : teste
    ...
    <body>
        <div class="jumbotron" >
            ...
            <center><h3> Por favor <%=nomeUsuario%> escolha seu prestador </h3>
                ...
                <br>
                <div class="row">
                    <% for (int i = 0; i < solem.size(); i++) {
                            p = prestadores.get(solem.get(i).getId_prestador());
                    %>
                    <div class="col-md-3 col-sm-">


                        <div class="w3-card-4" ><form action="AtualizaPrestadorEmEmergencial">
                                <header class="w3-container w3-light-grey">
                                    <h3  ><%= solem.get(i).getNome_prestador()%></h3>
                                </header>
                                <div >
                                    <% if (p.isSexo()) {%>
                                    ...
                                    <%}%>
                                    <hr>
                                    <h4>Valor do serviço = <%= solem.get(i).getValor()%> </h4><h6>+ <%= (solem.get(i).getValor() * 0.05)%> de taxa</h6><br>
                                    <p><%= cq.NivelStr(p)%> </p>
