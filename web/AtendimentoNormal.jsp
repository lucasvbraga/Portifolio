...
<html>
    ...
    <body >
        <div class="jumbotron" >
            ...
            <br><br><br><center><h2>Atendimento Normal</h2><h4>preencha as informações para solicitar o serviço.</h4><br><br>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-">
                        ...
                        <form action="" name="normal" method="POST">
            ...
            <br><br><br>
                ...
                if (de == "" || en == "") {
                    ...
                    document.forms['normal'].action = "buscaNormal";
                    document.forms['normal'].submit();
                }
            }
                        </script>
        <script>
