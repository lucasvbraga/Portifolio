 ...
 * @author Lucas
 */
public class detalhaAtendimento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!agendado.isEmpty()) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("detalheAgendado.jsp");
                ...
                RequestDispatcher rd = request.getRequestDispatcher("detalheNormal.jsp");
                rd.forward(request, response);
                ...
                RequestDispatcher rd = request.getRequestDispatcher("detalheEmergencial.jsp");
                rd.forward(request, response);
            } else {
