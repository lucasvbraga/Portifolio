 ...
 * @author Lucas
 */
public class enviaOferta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!agendado.isEmpty()) {
                ...
                session.setAttribute("atendimento", agendado);

                RequestDispatcher rd = request.getRequestDispatcher("enviarOfertaAgendado.jsp");
                rd.forward(request, response);

            } else if (!normal.isEmpty()) {

                session.setAttribute("atendimento", normal);

                RequestDispatcher rd = request.getRequestDispatcher("enviarOfertaNormal.jsp");
                rd.forward(request, response);

            } else if (!emergencial.isEmpty()) {

                session.setAttribute("atendimento", emergencial);

                RequestDispatcher rd = request.getRequestDispatcher("enviarOfertaEmergencial.jsp");
                rd.forward(request, response);
            } else {
