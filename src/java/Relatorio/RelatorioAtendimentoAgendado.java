 ...
 * @author Lucas
 */
public class RelatorioAtendimentoAgendado {

    Formatacoes fmat = new Formatacoes();

    public int QuantidadeTotal(List<Agendado> agendado, String data_digitada) {
        Date data = null;
    ...
    public List<Integer> QuantidadeEspecialidade(List<Especialidade> especialidades, List<Agendado> agendado) {
