 ...
 * @author Lucas
 */
public class ServicosAntigos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sn.close();
        session.setAttribute("antigosemergencial", emergencial);
        session.setAttribute("antigosnormal", normal);
        session.setAttribute("antigosagendado", agendado);

        RequestDispatcher rd = request.getRequestDispatcher("ServicosAntigos.jsp");
